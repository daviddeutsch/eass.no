			...
			<div id="content" class="clearfix">
				...
				<div id="main" class="col-sm-12 clearfix" role="main">
					<div ng-controller="HomeImgCtrl">
						...
						<div class="col-md-4 hoverable" ng-mouseover="change(0)" ng-mouseleave="reset()" ng-click="go('renhold')">
						...
						<div class="col-md-4 hoverable" ng-mouseover="change(1)" ng-mouseleave="reset()" ng-click="go('kantine')">
						...
						<div class="col-md-4 hoverable" ng-mouseover="change(2)" ng-mouseleave="reset()" ng-click="go('vaktmester')">
