			...
			<div id="content" class="clearfix">
				...
				<div id="main" class="col-sm-12 clearfix" role="main">
					<div ng-controller="HomeImgCtrl">
						...
						<div class="col-md-4" ng-mouseover="change(0)" ng-mouseleave="reset()" ng-href="/tjenester/##renhold">
						...
						<div class="col-md-4" ng-mouseover="change(1)" ng-mouseleave="reset()" ng-href="/tjenester/##kantine">
						...
						<div class="col-md-4" ng-mouseover="change(2)" ng-mouseleave="reset()" ng-href="/tjenester/##vaktmester">
